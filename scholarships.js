    ...
    return `
        <div class="scholarship-card">
            ...
            <div class="scholarship-footer">
                <a href="${scholarship.applyLink}" target="_blank" rel="noopener noreferrer" class="btn-apply" onclick="window.open('${scholarship.applyLink}', '_blank'); return false;">Apply Now</a>
            </div>
        </div>
    `;
}
